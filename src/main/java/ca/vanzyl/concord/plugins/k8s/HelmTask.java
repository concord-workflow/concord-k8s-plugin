...
@Named("helm")
public class HelmTask implements ToolTask {
  ...
  private static final Logger logger = LoggerFactory.getLogger(HelmTask.class);
  ...
  @Inject
  public HelmTask(LockService lockService, ObjectStorage objectStorage, SecretService secretService, ToolInitializer toolInitializer) {
