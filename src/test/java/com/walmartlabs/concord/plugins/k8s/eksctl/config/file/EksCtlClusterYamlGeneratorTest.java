...
public class EksCtlClusterYamlGeneratorTest extends ConcordTestSupport {
    ...
    @Test
    public void validateTerraformOutputParserWithNoNodeGroupkey() throws Exception {
    ...
    @Test
    public void validateTerraformOutputParserWithClusterLoggingEnabled() throws Exception {
